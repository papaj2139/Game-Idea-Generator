...
# Your extended lists of adjectives, nouns, and actions
...
# Create the main window with a dark blue background
root = tk.Tk()
root.title("Game Idea Generator")
root.configure(bg='#000044')  # Set background color to dark blue

# Create a label for displaying the generated idea with larger text and white foreground
idea_label = tk.Label(root, text="", wraplength=400, font=("Arial", 16), foreground="white", background='#000044')
idea_label.pack(pady=20)

# Create a "Generate Idea" button with larger text and a bigger size
generate_button = tk.Button(root, text="Generate Idea", command=generate_game_idea, font=("Arial", 14), width=20, height=2, background="#5E8A91", foreground="white")
